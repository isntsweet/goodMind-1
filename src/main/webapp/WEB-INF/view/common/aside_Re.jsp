...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	<div class="offcanvas offcanvas-start" id="nav">
		...
		<ul>
			...
			<div class="dropdown">
				<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" id="dropdown">게시판
...
<!--            <p><a href="#">admin@goodM.com</a></p>
	...
	<button class="btn-ham" type="button" id="ham" data-bs-toggle="offcanvas" data-bs-target="#nav">
