...
//다듬어진 첫번째 테스트 내용 예시  
	function getScores() {
		...
		if (totalScore >= 0 && totalScore <= 9) {
			...
			message = "당신의 점수는 " + totalScore + "점으로, 인터넷게임 사용 관련 장애가 있을 가능성이 있습니다.\n 추가적인 검사를 통해 인터넷게임 사용관련 장애가 있는지 확인해보시는 것을 추천합니다.";
		}
...
<body>
    ...
    <!-- 항목 시작(value 숫자 순서대로) -->
		...
		<tr style="background-color: #ccccff; vertical-align: middle;">
			...
			<th class="col-2">전혀 아님</th>
			<th class="col-1">가끔</th>
			<th class="col-1">자주</th>
			<th class="col-1">항상</th>
		</tr>
		 <tr class="survey">
		 	<td style="text-align: left;">1. 이전에 했던 인터넷게임에 대해 계속 생각하거나, 인터넷 게임을 할 생각에 몰두했다.</td>
		...
		<tr class="survey">
		    <td style="text-align: left;">2. 인터넷게임을 하지 않을때에는 초조하거나 불안하거나 슬프다.</td>
		...
		<tr class="survey">
		    <td style="text-align: left;">3. 인터넷에 쓰는 시간이 점점 길어진다.</td>
		...
		<tr class="survey">
		    <td style="text-align: left;">4. 인터넷게임을 하는 것을 조절하려고 해보았지만 성공하지 못했다.</td>
		...
		<tr class="survey">
		    <td style="text-align: left;">5. 인터넷게임으로 인해 예전의 다른 취미 생활이나 오락 활동에 대한 흥미가 줄어들었다.</td>
		...
		<tr class="survey">
		    <td style="text-align: left;">6. 사회적, 심리적 문제에도 불구하고 계속해서 인터넷게임을 과하게 한다.</td>
		...
		<tr class="survey">
		    <td style="text-align: left;">7. 가족이나 치료자, 또는 그 외의 사람에게 인터넷게임을 하는 데 사용한 시간을 속인 적이 있다.</td>
		...
		<tr class="survey">
		    <td style="text-align: left;">8. 부정적인 감정을 해소하거나 회피하기 위해 인터넷게임을 한다.</td>
		...
		<tr class="survey">
		    <td style="text-align: left;">9. 과도한 인터넷게임으로 인해 중요한 인간관계, 일, 교육이나 경력상의 기회를 위태롭게 하거나 잃은 적이 있다.</td>
