	...
	<%@ include file="../common/aside.jsp" %>
	    ...
	    <table class="table">
			<tr style="background-color: #ccccff; vertical-align: middle;">
				...
				<th class="col-1">한달내내</th>
				<th class="col-2">한달 중 대부분</th>
				<th class="col-2">한달 중 절반정도</th>
				<th class="col-1">한달 중 며칠</th>
				<th class="col-1">전혀 없었다</th>
			</tr>
			 <tr class="survey">
			    <td style="text-align: left;">1. 아무런 이유없이 기운이 없던 적이 얼마나 됩니까?</td>
			...
			<tr class="survey">
			    <td style="text-align: left;">2. 신경이 예민했던 날은 얼마나 됩니까?</td>
			...
			<tr class="survey">
			    <td style="text-align: left;">3. 신경이 너무 예민해서 귀하를 안정시킬 수 있는 것이 아무것도 없다고 느끼신 적이 얼마나 됩니까?</td>
			...
			<tr class="survey">
			    <td style="text-align: left;">4. 희망이 없다고 느끼신 적이 얼마나 됩니까?</td>
			...
			<tr class="survey">
			    <td style="text-align: left;">5. 안절부절 못하거나 조바심을 냈던 적은 얼마나 됩니까?</td>
			...
			<tr class="survey">
			    <td style="text-align: left;">6. 안절부절 못하거나 조바심을 내서 가만히 앉아있을 수 없다고 느끼신 적이 얼마나 됩니까?</td>
			...
			<tr class="survey">
			    <td style="text-align: left;">7. 우울했던 적이 얼마나 됩니까?</td>
			...
			<tr class="survey">
			    <td style="text-align: left;">8. 우울하여 기운을 북돋을 수 있는 것이 아무것도 없다고 느끼신 적이 얼마나 됩니까?</td>
			...
			<tr class="survey">
			    <td style="text-align: left;">9. 매사가 힘들다고 느끼신 적은 얼마나 됩니까?</td>
			...
			<tr class="survey">
			    <td style="text-align: left;">10. 자신을 가치없는 사람처럼 느끼신 적은 얼마나 됩니까?</td>
